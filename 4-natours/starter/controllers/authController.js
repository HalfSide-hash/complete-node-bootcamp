...
const createSendToken = (user, statusCode, res) => {
  ...
  if (process.env.NODE_ENV === 'production') cookieOptions.secure = true; //only want secure in prod
...
exports.forgotPassword = catchAsync(async (req, res, next) => {
  ...
  try {
    ...
    return next(
      new AppError('There was an error sending the emai. Try again later!'),
      500,
    );
  }
});
